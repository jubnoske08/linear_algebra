...
\end{equation*}
proving our claim.  Now, let $v_1,\dots, v_k$ be a basis of $E(\lambda_1, T)$ (necessarily eigenvectors).  Since $T\restr{R}$ is diagonalizable, it has a basis of eigenvectors by Theorem 5.41.  Call them $v_{k+1},\dots, v_n$.  By Equation \ref{eq19}, the list $v_1,\dots, v_n$ is a basis of $V$ consisting of eigenvectors of $T$.  By another application of Theorem 5.41, this implies $T$ is diagonalizable, as desired.
\end{proof}
\end{document}